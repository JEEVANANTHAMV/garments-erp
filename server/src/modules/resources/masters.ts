...
export const masterResources: ResourceConfig[] = [
  ...
  // ------------------------------------------------ Business partners
  {
    ...
    searchable: ['party_code', 'party_name', 'email', 'gstin'],
    ...
    children: [
      { key: 'addresses', table: 'mst_party_address', fk: 'party_id', fields: [
        ...
        f('city', s.nullableStr(80)), f('state', s.nullableStr(80)), f('country_id', s.id()),
        f('pincode', s.nullableStr(12)), f('is_default', s.bool()), f('is_active', s.bool()),
      ]},
      { key: 'contacts', table: 'mst_party_contact', fk: 'party_id', fields: [
        ...
        f('is_primary', s.bool()), f('is_active', s.bool()),
      ]},
      { key: 'banks', table: 'mst_party_bank', fk: 'party_id', fields: [
        ...
        f('currency_id', s.id()), f('is_default', s.bool()),
      ]},
    ],
    fields: [
      ...
      f('gstin', s.nullableStr(15)), f('pan', s.nullableStr(10)), f('tax_id_foreign', s.nullableStr(40)),
      f('payment_terms', s.nullableStr(120)), f('credit_limit', s.dec()), f('credit_days', s.int()),
