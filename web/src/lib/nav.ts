...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'General GRN & Inward', to: '/procurement/general-purchases', icon: Receipt, perms: ['PURCHASE.VIEW'] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Lay & Spreading',      to: '/production/lay-spreading', icon: Layers, perms: ['PRODUCTION.VIEW'] },
      { label: 'Cut QC & Bundles',     to: '/production/cut-qc-bundles', icon: Scissors, perms: ['PRODUCTION.VIEW'] },
      { label: 'Sewing & Finishing',   to: '/production/sewing-finishing', icon: Factory, perms: ['PRODUCTION.VIEW'] },
      ...
      { label: 'Line Allocations',     to: '/production/line-allocations', icon: GitBranch, perms: ['PRODUCTION.VIEW'] },
      ...
      { label: 'Production Costing',   to: '/production/costs', icon: Calculator, perms: ['PRODUCTION.VIEW'] },
    ],
  },
  {
    label: 'Quality',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Shipment Planning',   to: '/logistics/shipment-plans', icon: CalendarClock, perms: ['PACKING.VIEW', 'EXPORT.VIEW'] },
